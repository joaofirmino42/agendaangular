...
export class EdicaoTarefasComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //capturar os dados da tarefa atraves do id...
    const tarefa = this.tarefasService.obterPorId(parseInt(idTarefa));

    //prenecher o formulario com os dados da tarefa
    //prenecher o formulario com os dados da tarefa
  ...
  //permitindo acessar as propriedades de cada campo do formlário
  get form(): any {
    return this.formEdicao.controls;
  }
  //função para campturar o submit do formulário
  onSubmit(): void {
    var tarefa: Tarefa = {
